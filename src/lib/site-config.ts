...
export const siteConfig = {
  bandId: process.env.NEXT_PUBLIC_BAND_ID || "the-dutch-queen-unplugged",
  siteUrl: process.env.NEXT_PUBLIC_SITE_URL || "https://queenunplugged.nl",
  apiUrl: process.env.NEXT_PUBLIC_CMS_API_URL || "https://dutch-queen-admin.vercel.app/api",
  bandName: process.env.NEXT_PUBLIC_BAND_NAME || "The Dutch Queen Unplugged",
  siteToggle: {
